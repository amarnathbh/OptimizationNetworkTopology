...
var beta { d in demand_nos, l in virtual_links}>=0 binary;
var delta { d in demand_nos, v in virtual_nodes} >=0 binary;
...
subj to link_flow {d in demand_nos,v in virtual_nodes,s in service_nodes,c in dc_connect_nodes}:
	sum { l in virtual_links : v in virtual_nodes} beta[d,l] 
